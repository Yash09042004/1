...
WHERE name = 'Harsh Bamane';
-- before this enrollments should be deleted then there will not be any error of reference 
DELETE FROM enrollments WHERE student_id = (SELECT student_id FROM students WHERE name = 'Harsh Bamane');

-- Delete a course record
DELETE FROM courses
WHERE course_name = 'Bio101';